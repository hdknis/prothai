RailsAdmin.config do |config|
  ...
  config.actions do
   ...
   config.model 'Product' do
      ...
      LABEL_slider_photo1 = '写真１(この写真は企業検索ページのサムネイルとスライダーの１枚目になります)'
      LABEL_slider_photo2 = '写真2(スライダーの2枚目になります)'
      LABEL_slider_photo3 = '写真3(スライダーの3枚目になります)'
      LABEL_slider_photo4 = '写真4(スライダーの4枚目になります)'
